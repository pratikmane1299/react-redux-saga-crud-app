...
function PostForm({ loading, post = {}, mode = 'add', onSubmit }) {
  ...
  return (
    <div className="w-full h-full">
      <div className='px-4 py-4 mx-auto max-w-6xl bg-white'>
      ...
      <form className="mt-8 w-full flex flex-col" onSubmit={handlOnSubmit}>
        <div className="w-full flex flex-col rounded-md">
          <label className="mb-2 text-xs md:text-sm font-medium uppercase">Title</label>
          <input
            name="title"
            type="text"
            className="bg-gray-200 px-2 py-2 text-md md:text-lg rounded-md"
        ...
        <div className="mt-4 w-full flex flex-col rounded-md">
          <label className="mb-2 text-xs md:text-sm font-medium uppercase">Body</label>
          <textarea
            name="body"
            className="bg-gray-200 px-2 py-2 text-md md:text-lg rounded-md"
            rows={5}
